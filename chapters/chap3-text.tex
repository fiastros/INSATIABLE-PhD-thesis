...
% [This work lead to the production of scientific paper that could be submitted to a journal such as PCI Animal science or veterinary reseach as it may be of interrest to a community of veterinarians]

%-----------------------------------
%	SECTION 
%-----------------------------------
\section{Preprint in bioarxiv, 2025}

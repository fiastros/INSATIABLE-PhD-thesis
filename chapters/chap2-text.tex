...
% Cependant, bien que rapide et pratique, l’échographie pulmonaire reste difficile à interpréter car les images obtenues sont souvent en noir et blanc, bruitées, et ne montrent que des formes en deux dimensions. Certaines lésions situées profondément dans les poumons peuvent ainsi passer inaperçues. Malgré ces limites, cette méthode reste précieuse, car elle fournit rapidement des informations critiques à l’éleveur, permettant ainsi une prise en charge précoce de la maladie.

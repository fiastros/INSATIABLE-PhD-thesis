...
%	ACKNOWLEDGEMENTS
%----------------------------------------------------------------------------------------
\input{auxilliaires/Acknowledgements}
...
% \input{auxilliaires/foreword} %avant-propos
...
\input{chapters/chap1-text}
\input{chapters/thesis_outline}
\input{chapters/thesis_outline_french}
\input{chapters/chap2-text}
\input{chapters/chap3-text}
\input{chapters/chap4-text}

%\part*{Discussion et conclusion générale}
\fancyhead{} % clear all header fields
\fancyhead[OL]{\textsc{General discussion}}
\input{chapters/chap5-text}
...
\input{auxilliaires/abstract} %résumé
